...
import com.gateway.gwclient.common.JwtUtil;
...
public class AuthFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        /*以下为将token存放在cookie的情况*/
        MultiValueMap<String, HttpCookie> stringMultiValueMap = request.getCookies();
        List<HttpCookie> values = stringMultiValueMap.get("Authorization");
        String token = values.get(0).getValue();
